resource "google_sql_database_instance" "app_db_instance" {
  ...
  # maintenance_version  = "MYSQL_8_0_41.R20250531.01_14"
  master_instance_name = null
  root_password        = var.db_user_password # sensitive
  timeouts {
    create = "60m"
    delete = "60m"
  }
...
resource "google_sql_user" "db_user" {
  ...
  project  = var.project_id
  host     = "%"
  password = var.db_user_password # sensitive
}

# # __generated__ by Terraform
# # Please review these resources and move them into your main configuration files.

# # __generated__ by Terraform from "full-stack-app-db"
# resource "google_sql_database_instance" "full_stack_app_db" {
#   database_version     = "MYSQL_8_0_41"
#   deletion_protection  = true
#   encryption_key_name  = null
#   instance_type        = "CLOUD_SQL_INSTANCE"
...
#     }
#     ip_configuration {
#       allocated_ip_range                            = "172.23.64.0"
